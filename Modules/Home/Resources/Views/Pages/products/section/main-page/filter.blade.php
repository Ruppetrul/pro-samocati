...
{{--                        '{{ route('products.home') }}'--}}
    ...
    {{--                            </div>--}}
                                ...
                                <ul class="category-list custom-padding custom-height">
                                    ...
                                    <li>
                                        <div class="form-check ps-0 m-0 category-list-box">
                                            <input class="checkbox_animated" type="checkbox" name="categories[{{ $category['id'] }}]"
                                                   @if(
                                                        (array_search($category['id'], $selected_categories)) !== false)
                                                checked
                                                @endif>
                            ...
                            <br>
    {{--                        btn btn-success btn-block  col-sm-6 col-md-3 mg-t-10 mg-sm-t-0--}}
    {{--                        add-button addcart-button btn buy-button text-light--}}
    {{--                        [border-width || border-style || border-color] |--}}
                            <button style="border: 4px solid var(--theme-color);" type="submit" class="btn btn-success btn-block ">Применить фильтры</button>
                        </form>
                    </div>
                </div>
