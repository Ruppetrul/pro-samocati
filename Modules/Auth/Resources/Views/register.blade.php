                ...
                <div class="col-xxl-4 col-xl-5 col-lg-6 me-auto">
                    <div class="log-in-box">
                        <div class="log-in-title">
                            <h3>Добро пожаловтаь в магазин {{ config('app.name') }}</h3>
                            <h4>Регстрация</h4>
                        </div>
                        <div class="input-box">
                            <form class="row g-4" method="POST" action="{{ route('register') }}">
                                @csrf
                                <div class="col-12">
                                    <label for="" class="text-muted">Имя</label>
                                ...
                                <div class="col-12">
                                    <label for="" class="text-muted">Почта</label>
                                    <div class="form-floating theme-form-floating log-in-form">
                                        <x-auth-input name="email" id="email" value="{{ old('email') }}" type="email"
                                        placeholder="Email" />
                                        <x-share-error name="eFmail" />
                                    </div>
                                </div>
                                <div class="col-12">
                                    <label for="" class="text-muted">Телефон</label>
                                    <div class="form-floating theme-form-floating log-in-form">
                                ...
                                <div class="col-12">
                                    <label for="" class="text-muted">Пароль (минимум 8 символов)</label>
                                    <div class="form-floating theme-form-floating log-in-form">
