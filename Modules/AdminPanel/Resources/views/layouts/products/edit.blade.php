                ...
                <div class="card-body">
                    ...
                    <div class="row row-sm">
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <br>
                            <input class="form-control" type="text" readonly="readonly" value="{{$product['id']}}" name="product[id]">
                        </div>
                        <div class="col-12 mb-3">
                            <label for="" class="text-muted">Название</label>
                            <input class="form-control" value="{{$product['title']}}" type="text" name="product[title]" required>
                        </div>
                        <div class="col-12 mb-3">
                            <label for="" class="text-muted">Артикул</label>
                            <input class="form-control" value="{{$product['sku']}}" type="number" name="product[sku]" required>
                        </div>
                        <div class="col-12 mb-3">
                            <label for="" class="text-muted">Цена</label>
                            <input class="form-control" value="{{$product['price']}}" placeholder="id"  name="product[price]" required>
                        </div>
                        <div class="col-12 mb-3">
                            <label for="" class="text-muted">Количество</label>
                            <input type="number" class="form-control" value="{{$product['count']}}" placeholder=""  name="product[count]" required>
                        </div>
                        <div class="col-12 mb-3">
